...
/**
 * This class is used performing a monte carlo analysis for retirement purposes.
 * It uses data provided from a customer and simulates over N number of times the
 * how a clients savings will grow and then deplete during retirement.
...
public class MonteCarloAnalysis {
	...
	/**
	 * Default constructor for MonteCrloAnalysis object.
	 */
	...
	/**
	 * This method take the clients assets and simulates their growth based on randomly selecting market returns from
	 * our market returns data.  It will also factor in any savings or expenses the client may have each year pre and 
	 * post retirement.  
	 * @return Hashmap showing the growth of assets
	 */

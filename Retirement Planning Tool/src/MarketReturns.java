/**
 * Holds the market returns for a year for both equities and bonds.
 * The equity returns are the total return for the S&P 500 and the fixed 
 * income returns are taken from the Barclays Aggregate bond index.
